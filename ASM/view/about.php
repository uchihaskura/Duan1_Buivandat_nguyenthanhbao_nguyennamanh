...
<body>
    ...
    <section class="hand-crafted py-5">
        <div class="container">
            <div class="inner-sec py-md-5 px-lg-5">
                ...
                <p class="mb-4 text-center px-lg-4"> Đây là tài liệu trình bày quá trình phát triển của dự án Website cung cấp sản phẩn TB STORE, website được hướng đến những người đang có nhu cầu tìm kiếm một nơi để mua sắm các sản phẩm để phục vụ cho đôi chân của bạn nhưng chưa tìm được nơi nào uy tín để thực hiện điều đó thì TB STORE sẽ giúp bạn</p>
            </div>
        </div>
    </section>
    <!-- //ab -->
    ...
    <section class="about py-md-5 py-5">
        <div class="container py-md-3">
            <h3 class="tittle text-center">Chúng Tôi Cung Cấp Những Gì</h3>
            <div class="feature-grids row">
                <div class="col-md-4 gd-bottom mt-lg-4">
                    <div class="bottom-gd p-lg-5 p-4">
                        ...
                        <p>Đơn hàng trên 300.000đ</p>
                    </div>
                </div>
                <div class="col-md-4 gd-bottom mt-lg-4">
                    <div class="bottom-gd2-active p-lg-5 p-4">
                        <span class="fa fa-bullhorn" aria-hidden="true"></span>
                        <h3 class="my-3">Đổi trả miễn phí</h3>
                ...
                <div class="col-md-4 gd-bottom mt-lg-4">
                    <div class="bottom-gd p-lg-5 p-4">
                        ...
                        <h3 class="my-3">Giảm Giá Thành Viên</h3>
        ...
        <div class="container py-md-3">
            <div class="row banner-grids">
                <div class="col-md-6 banner-image">
                    <div class="effect-w3">
                        <img src="assets/logo.png.jpg"  class="img-fluid image1">
