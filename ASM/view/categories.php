<?php
    ...
    $stmt = $conn -> query("SELECT name FROM categories where id = $id_cate");
...
<body>
    ...
    <section class="about py-5">
        <div class="container pb-lg-3">
            ...
            <h3 class="tittle text-center">Danh Mục <?=$cate_name[0]?></h3>
            <div class="row">
                <div class="wrap-content">
                    <?php
                        ...
                        $stmt = $conn -> query("SELECT * FROM product where id_cate = $id_cate limit 16 offset $offset ");
