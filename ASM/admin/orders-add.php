...
<body>
   ...
   <div class="tab-content">
      ...
      <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3" style="display: <?php if($id != ""){echo "none";}else{echo "block";}?>;">
        ...
        <form action="admin.php?page=order_details&id_order=<?=$id?>" method="post">
            <button <?php if($id == ""){echo "style='display: none;'";}?> class="btn btn-success px-4" name="to_order_details">Xem Chi Tiết</button>
        </form>
      </div>
      </div> <!-- tab-pane -->
   </div>
