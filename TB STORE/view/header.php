...
<head>
    ...
    <link rel="icon" type="images/x-icon" href="assets/images/logotbstore.png" />
    <!-- Meta tag Keywords -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta charset="UTF-8" />
    <meta name="keywords" content="TB STORE" />
    <script>
        ...
        <nav class="py-4">
            ...
            <div class="container">
                <div class="main-menu">
                    ...
                    <div id="logo">
                        <a href="index.php"><img style="width: 250px; height: 100px;" src="assets/images/tbstore.png"
                                alt=""></a>
                    </div>
                    <div id="search">
